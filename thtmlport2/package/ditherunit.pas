...
{$IFNDEF LCL}  //Exclude assembler with LCL.
{$DEFINE PIXELFORMAT_TOO_SLOW}
{$ENDIF}

//			External dependecies
uses
  LclIntf, LclType, HtmlMisc, sysutils, Graphics, Classes;
...
type
  ...
  protected
    ...
    Width		: integer;
  public
    constructor Create(AWidth: integer; ALookup: TColorLookup); virtual;
  ...
  public
    constructor Create(AWidth: integer; ALookup: TColorLookup); override;
    destructor Destroy; override;
    function Dither(Red, Green, Blue: BYTE; var R, G, B: BYTE): char; override;
    procedure NextLine; override;
  end;

constructor TDitherEngine.Create(AWidth: integer; ALookup: TColorLookup);
begin
  inherited Create;
...
constructor TFloydSteinbergEngine.Create(AWidth: integer; ALookup: TColorLookup);
begin
  inherited Create(AWidth, ALookup);
